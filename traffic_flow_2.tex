...
\textit{Hint: Useful Matlab functions are: } \texttt{linspace, spdiags, u.\^ \! 2, full(A), spy(A)}
...
% The fact that cars entered the road at $x=0$ and all cars left the road at $x=L$ is purely defined by the boundary conditions. Show that the amount of cars is \textit{conserved} in the interior, i.e. show that
% \begin{align*}
